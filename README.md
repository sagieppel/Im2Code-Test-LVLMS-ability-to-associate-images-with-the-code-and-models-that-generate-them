# Im2Code: Test vision language models (VLM) ability to connect images with the code and models that generate them
...
The code supports APIs from OpenAI, Together.AI (Qwen, LLama), Grok,Gemini, and Claude. You can add other APIs to tools/VisualQuestion.py.

## 3. Run test (Run_Test_im2code_im2desc.py)

In **Run_Test_im2code_im2desc.py** in **__main__** set path to the  SciTextures images and code main folders.
